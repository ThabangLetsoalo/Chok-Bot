...
namespace WpfApp1
{
    class MainLogic : Utilities
    {
        ...
        private static readonly Dictionary<string, List<string>> HUD = new Dictionary<string, List<string>>
        {
            { "Good", new List<string> { "I am a Cyber-Security Awareness Bot.", "I help answer questions about Cyber-Security.", "My goal is to educate users on safe online practices." } },
            { "Not Good", new List<string> { "🕵️ Spyware secretly monitors your activity and collects personal information.", "⚠️ Be cautious when installing free software, as it may include spyware.", "🛡 Use anti-spyware tools to detect and remove spyware from your system.", "🔍 Avoid clicking on suspicious links that may lead to spyware downloads." } }
        };
        ...
        public void HUDResponse()
        {
            if (replie.Contains("good") || replie.Contains("great") || replie.Contains("fine") || replie.Contains("happy"))
            {
                ...
                Answer = $"🤖 I'm glad to hear that {name}! How can I assist you today?";
            }
